...
/*	    array(
	    ...
	    array(
	        ...
	        'inputs' => array(
				...
				array('id' => '24.7', 'label' => 'P210: Keep away from heat/sparks/open flames/hot surfaces – No smoking'),
				array('id' => '24.8', 'label' => 'P211: Do not spray on an open flame or other ignition source'),
				array('id' => '24.9', 'label' => 'P220: Keep/Store away from clothing/…/combustible materials'),
				...
				array('id' => '24.14', 'label' => 'P230: Keep wetted with …'),
				...
				array('id' => '24.22', 'label' => 'P241: Use explosion-proof electrical/ventilating/light/…/equipment'),
				...
				array('id' => '24.26', 'label' => 'P250: Do not subject to grinding/shock/…/friction'),
				array('id' => '24.27', 'label' => 'P251: Pressurized container – Do not pierce or burn, even after use'),
				...
				array('id' => '24.64', 'label' => 'P320: Specific treatment is urgent (see … on this label)'),
				array('id' => '24.65', 'label' => 'P321: Specific treatment (see … on this label)'),
				array('id' => '24.66', 'label' => 'P322: Specific measures (see … on this label)'),
				...
				array('id' => '24.97', 'label' => 'P377: Leaking gas fire – do not extinguish unless leak can be stopped safely'),
				...
				array('id' => '24.114', 'label' => 'P305+351+338: IF IN EYES: Rinse cautiously with water for several minutes. Remove contact lenses if present and easy to do – continue rinsing'),
				...
				array('id' => '24.131', 'label' => 'P401: Store … (to manually edit)'),
				...
				array('id' => '24.136', 'label' => 'P406: Store in a corrosive resistant/… container with a resistant inner liner'),
				array('id' => '24.137', 'label' => 'P407: Maintain air gap between stacks/pallets'),
				array('id' => '24.138', 'label' => 'P410: Protect from sunlight'),
				array('id' => '24.139', 'label' => 'P411: Store at temperatures not exceeding … °C/… °F (to manually edit)'),
				array('id' => '24.140', 'label' => 'P412: Do not expose to temperatures exceeding 50 °C/122 °F'),
				array('id' => '24.141', 'label' => 'P413: Store bulk masses greater than … kg/… lbs at temperatures not exceeding … °C/… °F (to manually edit)'),
				array('id' => '24.143', 'label' => 'P420: Store away from other materials'),
				array('id' => '24.144', 'label' => 'P422: Store contents under … (to manually edit)'),
				...
				array('id' => '24.149', 'label' => 'P410+412: Protect from sunlight. Do not expose to temperatures exceeding 50 °C/122 °F'),
				array('id' => '24.151', 'label' => 'P411+235: Store at temperatures not exceeding … °C/… °F. Keep cool (to manually edit)'),
